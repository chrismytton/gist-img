...
class GistImg < Formula
  url 'https://github.com/chrismytton/gist-img/archive/v0.0.1.zip'
  homepage 'https://github.com/chrismytton/gist-img'
  head 'https://github.com/chrismytton/gist-img.git'
